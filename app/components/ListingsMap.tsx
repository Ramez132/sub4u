  ...
  useEffect(() => {
    ...
    import("leaflet").then((L) => {
      ...
      const customIcon = L.divIcon({
        html: `<div style="background:#0891b2;width:32px;height:32px;border-radius:50% 50% 50% 0;transform:rotate(-45deg);border:3px solid white;box-shadow:0 2px 8px rgba(0,0,0,0.3);display:flex;align-items:center;justify-content:center;"><div style="transform:rotate(45deg);color:white;font-size:11px;font-weight:700;font-family:sans-serif;">₪</div></div>`,
        className: "",
        iconSize: [32, 32],
        iconAnchor: [16, 32],
        popupAnchor: [0, -36],
      ...
      mappableListings.forEach((listing) => {
        L.marker([listing.latitude!, listing.longitude!], { icon: customIcon })
          .addTo(map)
          .bindPopup(`
