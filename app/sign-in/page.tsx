        ...
        <div className="mx-auto max-w-md rounded-3xl border border-gray-200 bg-white p-8 shadow-sm">
          <div className="mb-8 flex gap-3">
            <button type="button" onClick={() => { setMode("signup"); setMessage(""); }}
              className={`rounded-full px-5 py-2 text-sm font-semibold ${mode === "signup" ? "bg-orange-500 text-white" : "bg-gray-100 text-gray-800"}`}>
              {t.signUp}
            </button>
            <button type="button" onClick={() => { setMode("signin"); setMessage(""); }}
              className={`rounded-full px-5 py-2 text-sm font-semibold ${mode === "signin" ? "bg-orange-500 text-white" : "bg-gray-100 text-gray-800"}`}>
              {t.signIn}
            </button>
          </div>
